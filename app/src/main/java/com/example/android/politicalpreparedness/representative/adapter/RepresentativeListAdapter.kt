...
class RepresentativeViewHolder(val binding: RepresentativeItemListBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    companion object{
        fun from(parent: ViewGroup):RepresentativeViewHolder  {
            ...
            val binding = RepresentativeItemListBinding.inflate(layoutInflater, parent, false)
...
class RepresentativeListener(val representativeListener:(official:Official)->Unit){
    fun onClick(representative: Representative) {representativeListener(representative.official)}
